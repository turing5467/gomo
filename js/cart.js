...
function renderOneShop(data) {
    ...
    let cart_shop_header = $('<div class="cart-shop-header "></div>').html(() => {
        let coupon_items = data.products[0][5].split(',').map((ele) => {
            return `<div class="cart-box-item clearfix">                        <div class="cart-coupon-icon cart-coupon-icon-red">         <div class="cart-coupon-icon-inner fontArial">                <em>¥</em>${ele.slice(ele.indexOf('，减')+1)}                                         </div>
            </div>                                     
            <div class="cart-coupon-text">                         <div class="cart-coupon-title text-overflow" title="">店铺券 ${ele.replace('券','满')}，特例商品不可用</div>     </div>
            <a class="cart-coupon-btn ">领取</a>
          </div>`;
        }).join('')
        return `
        ...
        <div class="cart-col-2">
            ...
            <div class="cart-coupon" style="margin-top: 6px;">                  <a href="javascript:;" class="c-i cart-coupon-trigger2 " act-get-coupon="" data-sid="80006441"></a>                           <div class="cart-coupon-box" gui-popupbox="">                          <div class="cart-coupon-box-mask pabs"></div>                     <div class="c-i closebtn-new hide" gui-popupclose=""></div>                         
                    <div class="cart-coupon-arrow pabs"><em class="c-i arrowup_gray"></em></div>                          
                    <div class="cart-box-border" gui-popupbox-animate="">       <div class="cart-coupon-items">                             ${coupon_items}                   
                      </div>
                    </div>
                </div>
            </div>
