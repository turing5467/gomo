const config = {
    ...
    data: './main_product_4.json', // json数据相当于当前文件的路径
    table: 'info', // 需要插入数据的数据表名
    arr: ['code', 'name', 'small_pics', 'price', 'prom_text', 'comment', 'shop_name', 'shop_zy_tag', 'promotion'] // 表单字段插入的顺序
}
